...
struct tests_make_package_error : virtual utility_make_package_error,
                                  virtual tests_error {};

class tests : public utility {
  BUNSAN_FACTORY_BODY(tests, const boost::filesystem::path & /*location*/,
